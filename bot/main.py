...
SIDE_PANEL_COMMANDS: list[BotCommand] = [
    ...
    BotCommand(command="shop", description="Товары торговца"),
    ...
    BotCommand(command="abilities", description="Способности"),
    BotCommand(command="use", description="Применить способность"),
    BotCommand(command="quests", description="Журнал квестов"),
    BotCommand(command="companions", description="Напарники"),
    BotCommand(command="levelup", description="Выбрать перк уровня"),
